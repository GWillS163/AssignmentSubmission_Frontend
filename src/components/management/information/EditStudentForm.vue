...
<div id="addStudent" aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" tabindex="-1">
      ...
      <div class="modal-body">
        ...
        <form class="row g-3">
          ...
          <div class="col-md-4">
            ...
            <input id="validationServer02" v-model="formData.studentId" class="form-control is-valid" required type="text">
            <!--              <div class="valid-feedback">-->
            <!--                看起来不错-->
            <!--              </div>-->
          </div>
