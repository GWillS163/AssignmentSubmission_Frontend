  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12 col-sm-6 col-md-6">
        <h3 class="text-dark mb-4">学生作业管理</h3>
      </div>
      ...
      <div class="card-header py-3">
        <div class="row table-topper align-items-center">
          <div class="col-12 col-sm-5 col-md-6 text-start" style="margin: 0px;padding: 5px 15px;">
            <p class="text-primary m-0 fw-bold">已交文件</p>
          </div>
        ...
        <div class="col-12">
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              <tbody>
              <tr>
                <td class="text-truncate" style="max-width: 200px;">JAVA基础与开发 <br></td>
                <td class="text-truncate" style="max-width: 200px;">Java</td>
                <td><span style="color: rgb(231, 139, 100);">即将截止</span></td>
                <td>桌面端提交<br></td>
                <td>2022-7-17 17:46:37</td>
                <td class="text-center align-middle" style="max-height: 60px;height: 60px;"><a
                    class="btn btnMaterial btn-flat primary semicircle" role="button" href="#"><i
                    class="far fa-eye"></i></a><a class="btn btnMaterial btn-flat success semicircle" role="button"
                                                  href="#"><i class="fas fa-pen"></i></a><a
                    class="btn btnMaterial btn-flat accent btnNoBorders checkboxHover" role="button"
                    style="margin-left: 5px;" data-bs-toggle="modal" data-bs-target="#delete-modal" href="#"><i
                    class="fas fa-trash btnNoBorders" style="color: #DC3545;"></i></a></td>
              </tr>
              <tr>
                <td class="text-truncate" style="max-width: 200px;">孟骏清</td>
                <td class="text-truncate" style="max-width: 200px;">数据结构</td>
                <td>已被检查</td>
                <td>Windows DesktopV2.1</td>
                <td>2022-7-17 17:46:37</td>
                <td class="text-center align-middle" style="max-height: 60px;height: 60px;"><a
                    class="btn btnMaterial btn-flat primary semicircle" role="button" href="#"><i
                    class="far fa-eye"></i></a><a class="btn btnMaterial btn-flat success semicircle" role="button"
