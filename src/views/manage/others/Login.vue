        ...
        <div class="row">
          <div class="col-lg-6 d-none d-lg-flex">
            <div class="flex-grow-1 bg-login-image" style="background-color: #9bc6fe">
              <!--                          <img src="../../../assets/img/octocat-23.png"/>-->
            </div>
          </div>
          <div class="col-lg-6">
              ...
              <form class="user">
                ...
                <div class="mb-3">
                  <div class="custom-control custom-checkbox small">
                    <div class="form-check"><input id="formCheck-1" class="form-check-input custom-control-input"
                                                   type="checkbox"><label class="form-check-label custom-control-label"
                                                                           for="formCheck-1">请记住我</label></div>
                  </div>
                </div>
                <a class="btn btn-primary d-block btn-user w-100" href="../staticDesign/index.html"
                   role="button">登录</a>
                <hr>
                ...
                QQ 登录</a>
                <div class="justify-content-between mt-lg-3" style="display: flex;"><a class="small"
                                                                                       href="register.html">创建账户</a><a
                    class="small" href="forgot-password.html">忘记密码?</a></div>
                <hr>
              </form>
